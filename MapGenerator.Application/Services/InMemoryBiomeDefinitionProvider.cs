    ...
    [
        ...
        new()
        {
            ...
            [
                ...
                new() { ResourceId = "WildGarlic",  Probability = 0.10f },
                new() { ResourceId = "CattailRoot", Probability = 0.12f },
        ...
        new()
        {
            ...
            [
                ...
                new() { ResourceId = "Herbs",       Probability = 0.15f },
                new() { ResourceId = "CattailRoot", Probability = 0.18f },
        ...
        new()
        {
            ...
            [
                ...
                new() { ResourceId = "WildCarrot", Probability = 0.14f },
                new() { ResourceId = "Feathers",   Probability = 0.12f },
                new() { ResourceId = "Flint",      Probability = 0.10f },
        ...
        new()
        {
            ...
            [
                ...
                new() { ResourceId = "WildCarrot", Probability = 0.18f },
        ...
        new()
        {
            ...
            [
                ...
                new() { ResourceId = "BaobabFruit", Probability = 0.15f },
                new() { ResourceId = "Yam",         Probability = 0.12f },
        ...
        new()
        {
            ...
            [
                ...
                new() { ResourceId = "Acorn",       Probability = 0.22f },
                new() { ResourceId = "WildGarlic",  Probability = 0.12f },
                new() { ResourceId = "PineNut",     Probability = 0.15f },
        ...
        new()
        {
            ...
            [
                ...
                new() { ResourceId = "Yam",         Probability = 0.15f },
                new() { ResourceId = "HeartOfPalm", Probability = 0.12f },
        ...
        new()
        {
            ...
            [
                ...
                new() { ResourceId = "RockLichen", Probability = 0.15f },
                new() { ResourceId = "PineNut",    Probability = 0.10f },
