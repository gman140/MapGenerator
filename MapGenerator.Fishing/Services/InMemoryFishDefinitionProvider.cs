...
public class InMemoryFishDefinitionProvider : IFishDefinitionProvider
{
    ...
    [
        ...
        new() {
            Id = "RiverTrout", Name = "River Trout", PoleTier = 0, RarityWeight = 3f,
        ...
        new() {
            Id = "FreshwaterPerch", Name = "Freshwater Perch", PoleTier = 0, RarityWeight = 3f,
        ...
        new() {
            Id = "Catfish", Name = "Catfish", PoleTier = 0, RarityWeight = 2f,
        ...
        new() {
            Id = "RiverEel", Name = "River Eel", PoleTier = 0, RarityWeight = 1.5f,
        ...
        new() {
            Id = "FreshwaterCrab", Name = "Freshwater Crab", PoleTier = 0, RarityWeight = 1.5f,
        ...
        new() {
            Id = "GiantCarp", Name = "Giant Carp", PoleTier = 0, RarityWeight = 0.4f,
        ...
        new() {
            Id = "Sandfish", Name = "Sandfish", PoleTier = 0, RarityWeight = 2.5f,
        ...
        new() {
            Id = "TideMullet", Name = "Tide Mullet", PoleTier = 0, RarityWeight = 3f,
        ...
        new() {
            Id = "ShoreCrab", Name = "Shore Crab", PoleTier = 0, RarityWeight = 2f,
        ...
        new() {
            Id = "Flounder", Name = "Flounder", PoleTier = 0, RarityWeight = 2f,
        ...
        new() {
            Id = "Seahorse", Name = "Seahorse", PoleTier = 0, RarityWeight = 0.5f,
        ...
        new() {
            Id = "SwampEel", Name = "Swamp Eel", PoleTier = 0, RarityWeight = 2f,
        ...
        new() {
            Id = "Mudfish", Name = "Mudfish", PoleTier = 0, RarityWeight = 2.5f,
        ...
        new() {
            Id = "MarshCrab", Name = "Marsh Crab", PoleTier = 0, RarityWeight = 1.5f,
        ...
        new() {
            Id = "MountainTrout", Name = "Mountain Trout", PoleTier = 1, RarityWeight = 2.5f,
        ...
        new() {
            Id = "Salmon", Name = "Salmon", PoleTier = 1, RarityWeight = 2f,
        ...
        new() {
            Id = "GlacialChar", Name = "Glacial Char", PoleTier = 1, RarityWeight = 1.5f,
        ...
        new() {
            Id = "GoldenTrout", Name = "Golden Trout", PoleTier = 1, RarityWeight = 0.4f,
        ...
        new() {
            Id = "Clownfish", Name = "Clownfish", PoleTier = 1, RarityWeight = 2f,
        ...
        new() {
            Id = "Parrotfish", Name = "Parrotfish", PoleTier = 1, RarityWeight = 1.5f,
        ...
        new() {
            Id = "Triggerfish", Name = "Triggerfish", PoleTier = 1, RarityWeight = 1.5f,
        ...
        new() {
            Id = "MorayEel", Name = "Moray Eel", PoleTier = 1, RarityWeight = 1f,
        ...
        new() {
            Id = "Lionfish", Name = "Lionfish", PoleTier = 1, RarityWeight = 0.5f,
        ...
        new() {
            Id = "MirrorCarp", Name = "Mirror Carp", PoleTier = 1, RarityWeight = 2f,
        ...
        new() {
            Id = "LakeBass", Name = "Lake Bass", PoleTier = 1, RarityWeight = 2.5f,
            Description = "Medium. Reliable. Exactly what you expect from a lake fish in a lake.",
            WaitTimeMinSec = 3, WaitTimeMaxSec = 6, StrikeWindowMs = 700, MaxMissedStrikes = 2,
            TensionDrainRate = 0.08, ReelResistance = 0.11, BurstChancePerSec = 0.10, BurstStrength = 0.14, ReelRate = 0.15,
        },
        new() {
            Id = "Moonfish", Name = "Moonfish", PoleTier = 1, RarityWeight = 0.6f,
        ...
        new() {
            Id = "LegendaryMoonfish", Name = "Legendary Moonfish", PoleTier = 1, RarityWeight = 0.08f,
        ...
        new() {
            Id = "KelpGrouper", Name = "Kelp Grouper", PoleTier = 2, RarityWeight = 2f,
        ...
        new() {
            Id = "Rockfish", Name = "Rockfish", PoleTier = 2, RarityWeight = 2f,
        ...
        new() {
            Id = "Octopus", Name = "Octopus", PoleTier = 2, RarityWeight = 1f,
        ...
        new() {
            Id = "SeaBass", Name = "Sea Bass", PoleTier = 2, RarityWeight = 2.5f,
        ...
        new() {
            Id = "GiantSquid", Name = "Giant Squid", PoleTier = 2, RarityWeight = 0.2f,
        ...
        new() {
            Id = "Anglerfish", Name = "Anglerfish", PoleTier = 2, RarityWeight = 0.6f,
        ...
        new() {
            Id = "Ghostfish", Name = "Ghostfish", PoleTier = 2, RarityWeight = 0.8f,
        ...
        new() {
            Id = "AbyssalEel", Name = "Abyssal Eel", PoleTier = 2, RarityWeight = 0.5f,
        ...
        new() {
            Id = "PaleCavefish", Name = "Pale Cavefish", PoleTier = 2, RarityWeight = 1.5f,
            Description = "No eyes. No pigment. Navigates entirely by pressure sense. Being on a hook is novel for it.",
            WaitTimeMinSec = 4, WaitTimeMaxSec = 8, StrikeWindowMs = 620, MaxMissedStrikes = 2,
            TensionDrainRate = 0.09, ReelResistance = 0.12, BurstChancePerSec = 0.12, BurstStrength = 0.16, ReelRate = 0.14,
        },
        new() {
            Id = "VolcanicEel", Name = "Volcanic Eel", PoleTier = 2, RarityWeight = 1f,
        ...
        new() {
            Id = "ThermophilicShrimp", Name = "Thermophilic Shrimp", PoleTier = 2, RarityWeight = 0.6f,
        ...
        new() {
            Id = "BioluminescentJellyfish", Name = "Bioluminescent Jellyfish", PoleTier = 3, RarityWeight = 1.5f,
        ...
        new() {
            Id = "AbyssalAnglerfish", Name = "Abyssal Anglerfish", PoleTier = 3, RarityWeight = 0.7f,
        ...
        new() {
            Id = "GlowingSquid", Name = "Glowing Squid", PoleTier = 3, RarityWeight = 1f,
        ...
        new() {
            Id = "IceShrimp", Name = "Ice Shrimp", PoleTier = 4, RarityWeight = 2f,
        ...
        new() {
            Id = "CrystalFish", Name = "Crystal Fish", PoleTier = 4, RarityWeight = 1f,
        ...
        new() {
            Id = "FrozenEel", Name = "Frozen Eel", PoleTier = 4, RarityWeight = 0.8f,
        ...
        new() {
            Id = "ArcticTrout", Name = "Arctic Trout", PoleTier = 4, RarityWeight = 1.5f,
        ...
        new() {
            Id = "PolarStar", Name = "Polar Star", PoleTier = 4, RarityWeight = 0.5f,
        ...
        new() {
            Id = "AncientFish", Name = "Ancient Fish", PoleTier = 4, RarityWeight = 0.12f,
